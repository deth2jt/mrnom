...
public class ZBlendingTest extends GLGame {
    ...
    class ZBlendingScreen extends GLScreen {
        ...
        public ZBlendingScreen(Game game) {
            ...
            vertices.setVertices(new float[] { -0.5f, -0.5f, -3, 1, (float) 0.5, (float) 0.5, 0.5f,
                                                0.5f, -0.5f, -3, 1, (float) 0.5, (float) 0.5, 0.5f,
                                                0.0f,  0.5f, -3, 1, (float) 0.5, (float) 0.5, 0.5f,
                                                0.0f,  -0.5f, -5, 0, 1, 0, 1,
                                                1.0f,  -0.5f, -5, 0, 1, 0, 1,
        ...
        public void present(float deltaTime) {
            ...
            gl.glLoadIdentity();           
            GLU.gluPerspective(gl, 135, 
                    glGraphics.getWidth() / (float)glGraphics.getHeight(), 
                    0.1f, 10f);
            gl.glMatrixMode(GL10.GL_MODELVIEW);
            gl.glLoadIdentity();    
            
            //gl.glAlphaFunc (GL10.GL_GREATER, (float) 0.5 ) ;
