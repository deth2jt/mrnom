...
public class Camera2DTest extends GLGame {
	...
	class Camera2DScreen extends Screen {
	    ...
	    Vertices1 cannonVertices;
	    Vertices1 ballVertices;
	    Vertices1 targetVertices;
	    ...
	    public Camera2DScreen(Game game) {
	        ...
	        cannonVertices = new Vertices1(glGraphics, 3, 0, false, false);
	        cannonVertices.setVertices(new float[] { -0.5f, -0.5f, 
	                                                  0.5f, 0.0f, 
	                                                 -0.5f, 0.5f }, 0, 6);
	        
	        ballVertices = new Vertices1(glGraphics, 4, 6, false, false);            
	        ...
	        targetVertices = new Vertices1(glGraphics, 4, 6, false, false);
