...
public class TextureAtlasTest extends GLGame {
	...
	class TextureAtlasScreen extends Screen {
	    ...
	    public TextureAtlasScreen(Game game) {
	        ...
	        cannonVertices = new Vertices1(glGraphics, 4, 6, false, true);
	        ...
	        ballVertices = new Vertices1(glGraphics, 4, 6, false, true);            
	        ...
	        targetVertices = new Vertices1(glGraphics, 4, 6, false, true);
